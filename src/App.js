  ...
  return (
    <ThemeProvider theme={theme}>
      <Router>
        ...
        <Typography variant="h1" sx={{ textAlign: 'center', margin: '20px 0', color: 'white', marginTop: '60px', textShadow: '#ec4b41 -2px -2px 0px, #ec4b41 2px -2px 0px, #ec4b41 -2px 2px 0px, #ec4b41 2px 2px 0px', }}>
            PokeInfo
          </Typography>

          <div className="search-bar-container">
    <SearchBar setSearchResults={setSearchResults}></SearchBar>
    <SearchResultsList searchResults={searchResults}></SearchResultsList>
    </div>
    ...
    <Divider sx={{ marginBottom : '50px', borderColor : '#6c757d' }}></Divider>
